...
//   const[mapClicked, setLegClicked] = useState([]);
      ...
      return chords.map((connection, i) => {
        ...
        return (
          <path
            ...
            d={d}
            fill={fillColor}
            opacity={hoveredChordIndex === i ? 0.75 : 0.3}
            stroke={hoveredChordIndex === i ? "#FFFF00" : fillColor}
            strokeWidth={hoveredChordIndex === i ? 1.5 : 0.5}
            onMouseOut={(e) => {
              setHoveredChordIndex(null)
                setTooltipVisible(false);
              }}
